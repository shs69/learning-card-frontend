	...
	return (
		...
		>
			<label
				{...getRootProps()}
				className={cn(
					"dark:bg-input/10 flex w-full min-w-72 cursor-pointer flex-col items-center justify-center rounded-lg bg-transparent px-2 py-6 transition-colors aspect-square",
					{
			...
			>
				...
				<div className="mt-3 space-y-1 text-center">
					<p className="text-sm font-semibold">Перетащите файлы сюда</p>
